...
namespace Cue.Networking
{
    ...
    /// </summary>
    public class DeleteRequest : IUnityWebRequest
    {
        ...
        public DeleteRequest(string requestKey, Action<string> successHandler, Action<string> errorHandler) : base(requestKey, successHandler, errorHandler)
        {
        }
    }
}