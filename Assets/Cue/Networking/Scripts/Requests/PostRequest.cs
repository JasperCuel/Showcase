...
namespace Cue.Networking
{
    ...
    /// </summary>
    public class PostRequest : IUnityWebRequest
    {
        ...
        public PostRequest(string requestKey, Action<string> successHandler, Action<string> errorHandler, List<IMultipartFormSection> form) : base(requestKey, successHandler, errorHandler)
        {
            this.form = form;
        }
    }
